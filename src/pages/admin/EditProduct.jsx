      ...
      try {
        ...
        if (data.success) {
          ...
          setFormData({
            ...
            variants: product.variants && product.variants.length > 0 ? product.variants : [{ size: '', price: '', priceDisplay: '' }],
          });
            ...
            <div className="form-card">
              ...
              <div className="form-group">
                ...
                <select name="category" value={formData.category} onChange={handleChange} required>
                  <option value="Phong Thuỷ">Phong Thuỷ</option>
                  <option value="Đồ Dùng Tôn Giáo">Đồ Dùng Tôn Giáo</option>
                </select>
              </div>
            ...
            <div className="form-card">
              ...
              <div className="image-upload-section">
                ...
                <div className="image-gallery-preview">
                  ...
                  {/* Nút thêm ảnh trong dạng ô vuông giống Shopee */}
                  <div className="gallery-item add-more-box">
                    <label className="add-more-label">
                      <input type="file" multiple accept="image/*" onChange={handleFileUpload} disabled={uploadingImages} />
                      <Plus size={24} color="#a89f91" />
                      <span>{uploadingImages ? 'Đang tải...' : 'Thêm ảnh'}</span>
                    </label>
                  </div>
                </div>
              </div>
